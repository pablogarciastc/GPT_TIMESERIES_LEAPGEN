...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--shuffle', default=False, help='shuffle thei data order')
    ...
    subparsers.add_argument('--top_k_l', default=3, type=int, )
    ...
    subparsers.add_argument('--pull_constraint_coeff2', default=1.0, type=float)
    subparsers.add_argument('--intertask_coeff', default=1.0, type=float)
    subparsers.add_argument('--k_mul', default=50.0, type=float)
    subparsers.add_argument('--same_key_value', default=False, type=bool)
    subparsers.add_argument('--dualopt', default=True, type=bool)
    subparsers.add_argument('--cudnn_benchmark', default=False, type=bool)
    # subparsers.add_argument('--dualopt', default=False, type=bool)
