...
def get_args_parser(parser):
    ...
    parser.add_argument('--pull_constraint_coeff', default=0.001, type=float)
    parser.add_argument('--pull_constraint_coeff2', default=0.001, type=float)
    parser.add_argument('--intertask_coeff', default=0.001, type=float)
