...
def get_args_parser(parser):
    ...
    # Training parameters
    # -------------------
    parser.add_argument('--batch-size', default=1, type=int, help='Batch size per device')
    ...
    parser.add_argument('--g_prompt_length', default=3, type=int, help='Length of G-Prompt')
    parser.add_argument('--g_prompt_layer_idx', default=[], type=int, nargs="+", help='The layer index of the G-Prompt')
    ...
    parser.add_argument('--e_prompt_layer_idx', default=[0, 1, 2, 3, 4, 5, 6], type=int, nargs="+",
